...
res_workflows = requests.get("https://api.github.com/repos/apache/lucene/actions/workflows", auth= ("Geovani Reolon", "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"))
...
def count_jobs_runs(i, runs, l_jobs):
    ...
    res_jobs = requests.get(path_2, auth= ("Geovani Reolon", "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")) 
    jobs = res_jobs.json()
...
def calculate_runs(i,n): # n define quantos runs serão pegas
    ...
    res_runs = requests.get(path, auth= ("Geovani Reolon", "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"))
...
# pi_url = "http://api.github.com/repos/"
# repo_path = "apache/lucene"
# full_repo_path = api_path + repo_path
# request_path = full_repo_path + /caminho do método especifico/
# Colocar como inputs as entradas, mudar caminhos, verificar caso do tempo das runs e colocar tudo numa função main
# Compactar prints em uma função - Check
# Conectar o token - Check
# Desconsiderar casos que deram falha

# Caso de tempo muito grande - Hunspell run 123 -  "run_attempt": 2